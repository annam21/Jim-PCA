# Exactly the same as ggbiplot, but allows you to change linetype of the 
# ellipse (line 124)
# Put opaque background behind PCA labels line 130
          ...
          ...) 
{
  ...
  if (var.axes) {
    g <- g + geom_label(data = df.v, aes(label = varname, 
